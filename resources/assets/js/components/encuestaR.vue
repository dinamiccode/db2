  ...
  <div>
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span>Formulario Encuesta Respondida</span>
      </div>
      <el-form  :model="form" ref="form" label-width="120px" :rules="rules">
        ...
        <el-row :gutter="20">
         ...
         <el-col :span="12">
            <el-form-item label="Correlativo:" prop="descripcion">
...
export default {
  ...
  methods: {
    onSubmit(form) {
        ...
        var url = '/addEncuestaR';
        this.$refs[form].validate(valid => {
        const h = this.$createElement;
        if (valid) {
            this.fullscreenLoading = true;        
            axios.post(url, {
                encuesta: this.form.pregunta,
                cliente: this.form.cliente,
                correlativo: this.form.descripcion,
